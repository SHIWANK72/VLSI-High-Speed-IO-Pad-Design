...
set ::env(SYNTH_TRISTATE_MAP) /root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tribuff_map.v
set ::env(SYNTH_CSA_MAP) /root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/csa_map.v
set ::env(SYNTH_RCA_MAP) /root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/rca_map.v
set ::env(SYNTH_FA_MAP) /root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/fa_map.v
...
set ::env(VERILOG_FILES) ./io_pad_wrapper.v
set ::env(VERILOG_POWER_DEFINE) USE_POWER_PINS
set ::env(USE_SYNLIG) 0
set ::env(SYNLIG_DEFER) 0
set ::env(SAVE_NETLIST) /content/openlane_run/20-yosys-synthesis/io_pad_wrapper.nl.v
