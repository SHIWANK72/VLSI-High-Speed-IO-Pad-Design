...
set ::env(CURRENT_ODB) /content/openlane_run/27-openroad-cts/io_pad_wrapper.odb
set ::env(SAVE_ODB) /content/openlane_run/28-openroad-globalrouting/io_pad_wrapper.odb
set ::env(SAVE_DEF) /content/openlane_run/28-openroad-globalrouting/io_pad_wrapper.def
